    ...
    return (
      <article className="project-wrapper">
        <div className="project">
          ...
          {item.thumb ? <img src={`${process.env.NODE_ENV === 'development' ? '/' : ''}${item.thumb}`} className="thumb" /> : <div className="thumb no-thumb"><i className="fa fa-television fa-5x" aria-hidden="true"></i></div>}
